                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <div class="float-sm-right">
                                <a href="./view/ajouter.php" class="btn btn-info">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="dropdown input-group">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <a class="dropdown-item" href="./view/projects/{{$project->id}}/tasks">Projet2</a>
                                                <a class="dropdown-item" href="./view/projects/{{$project->id}}/tasks">Projet3</a>
                                            </div>
                                        </div>
